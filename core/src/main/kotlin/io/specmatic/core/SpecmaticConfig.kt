...
data class SpecificationSourceEntry(
    ...
    constructor(source: Source, specFile: File, specPathInConfig: String, baseUrl: String?, port: Int?, resiliencyTestSuite: ResiliencyTestSuite?) : this(
        ...
        port = port,
        baseUrl = baseUrl,
        webSourceUrl = source.resolvedWebBaseUrl,
        resiliencyTestSuite = resiliencyTestSuite,
        type = source.resolvedProvider,
        repository = source.resolvedRepository,
        directory = source.resolvedDirectory,
        branch = source.resolvedBranch,
        matchBranch = source.resolvedMatchBranch,
        exampleDirs = null,
    )
}
