...
class GenerativeTests {
    ...
    fun `should generate negative tests for a specification where the request body is an array and there exists a named example for the same`() {
        ...
        assertThat(testDescriptions.sorted().distinct()).containsExactlyInAnyOrder(
            ...
            "-ve  Scenario: POST /items -> 4xx with the request from the example 'sampleItems' where REQUEST.BODY.[].name is mutated from string to boolean AND REQUEST.BODY.[].quantity is set to the largest possible value",
            "-ve  Scenario: POST /items -> 4xx with the request from the example 'sampleItems' where REQUEST.BODY.[].name is mutated from string to boolean AND REQUEST.BODY.[].quantity is set to the smallest possible value '1'",
            ...
            "-ve  Scenario: POST /items -> 4xx with the request from the example 'sampleItems' where REQUEST.BODY.[].name is mutated from string to null AND REQUEST.BODY.[].quantity is set to the largest possible value",
            "-ve  Scenario: POST /items -> 4xx with the request from the example 'sampleItems' where REQUEST.BODY.[].name is mutated from string to null AND REQUEST.BODY.[].quantity is set to the smallest possible value '1'",
            ...
            "-ve  Scenario: POST /items -> 4xx with the request from the example 'sampleItems' where REQUEST.BODY.[].name is mutated from string to number AND REQUEST.BODY.[].quantity is set to the largest possible value",
            "-ve  Scenario: POST /items -> 4xx with the request from the example 'sampleItems' where REQUEST.BODY.[].name is mutated from string to number AND REQUEST.BODY.[].quantity is set to the smallest possible value '1'",
