...
dependencies {
    ...
    implementation("io.ktor:ktor-client-apache-jvm:3.6.0")
    implementation("io.ktor:ktor-server-cors-jvm:3.6.0")
    implementation("io.ktor:ktor-server-double-receive-jvm:3.6.0")
    implementation("io.ktor:ktor-server-content-negotiation-jvm:3.6.0")
    implementation("io.ktor:ktor-serialization-jackson-jvm:3.6.0")
